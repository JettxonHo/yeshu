...
1. main 当前是 `eb20515c6db0b2c5cee1db85e45bfc2c24055f77`(PR #2 Squash Merge,V2-a 交互状态机,2026-08-01T19:24:58Z 合并;其上 main CI run `30714704443` worker / python 双绿)。
...
8. 当前下一项是 **Reliability Hardening**,不是应用主页、段位成就或前端美化;生产验证完成前不进入新产品功能。
...
- 部署版本与回滚:记录部署 SHA、保留上一稳定版本、明确回滚步骤(2026-08-02 部署已人工实践一次:部署前代码包快照 + 回滚程序、本地持久化;尚未工具化,FC 侧亦无版本/别名机制);
